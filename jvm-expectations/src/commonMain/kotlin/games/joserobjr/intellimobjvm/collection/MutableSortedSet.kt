 ...
 * 4) A constructor with a single argument of type `MutableSortedSet`,
 ...
 * `high`, inclusive: `val sub: MutableSortedSet<String> = s.subSet(low, high+"\0")`
 *
 * A similar technique can be used to generate an *open range* (which
 * contains neither endpoint).  The following idiom obtains a view
 * containing all of the Strings in `s` from `low` to
 * `high`, exclusive: `val sub: MutableSortedSet<String> = s.subSet(low+"\0", high);`
 *
 * @param E the type of elements maintained by this set
 */
public expect interface MutableSortedSet<E> : MutableSet<E> {
    /**
     ...
     */
    public fun subSet(fromElement: E, toElement: E): MutableSortedSet<E>
     ...
     * bounds of the range
     */
    public fun headSet(toElement: E): MutableSortedSet<E>
     ...
     * bounds of the range
     */
    public fun tailSet(fromElement: E): MutableSortedSet<E>
