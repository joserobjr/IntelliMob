 ...
 */
public expect fun <K : Comparable<K>, V> Map<out K, V>.toMutableSortedMap(): MutableSortedMap<K, V>
 ...
 */
public expect fun <K, V> Map<out K, V>.toMutableSortedMap(comparator: Comparator<in K>): MutableSortedMap<K, V>
