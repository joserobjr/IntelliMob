 ...
 */
public actual inline fun <K : Comparable<K>, V> mutableSortedMapOf(vararg pairs: Pair<K, V>): MutableSortedMap<K, V> = sortedMapOf(*pairs)
 ...
 */
public actual inline fun <K, V> mutableSortedMapOf(comparator: Comparator<in K>, vararg pairs: Pair<K, V>): MutableSortedMap<K, V> = sortedMapOf(comparator, * pairs)
